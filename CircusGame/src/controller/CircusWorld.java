...
public class CircusWorld implements World {
    ...
    private boolean objectIntersectLeft(GameObject o) {
        ...
        return (Math.abs(clown.getX() - o.getX()) <= o.getWidth() - 10
                && o.getY() == clown.getY() - o.getHeight());//height
    }
    ...
    public void checkScore(List<GameObject> hand) {
        if (hand.size() >= 3) {
            ...
            if (z1.getImageName().equals(z2.getImageName()) && z2.getImageName().equals(z3.getImageName())) {
                hand.remove(z1);
                hand.remove(z2);
                hand.remove(z3);
                control.remove(z1);
    ...
    public boolean refresh() {
        ...
        for (int i = 0; i < moving.size(); i++) {
            ...
            if (leftHand.isEmpty()) {
                ...
                if (intersect2(leftHand.get(leftHand.size() - 1), o)) {
                    moving.remove(o);
                    if (o instanceof Bomb) {
                        noOfLives--;
                        sound.boom();
            ...
            if (rightHand.isEmpty()) {
                ...
                if (intersect2(o, rightHand.get(rightHand.size() - 1))) {
                    moving.remove(o);
                    if (o instanceof Bomb) {
                        noOfLives--;
                        sound.boom();
